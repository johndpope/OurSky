...
protocol UserManagerDelegate: class {
    ...
    func manager(manager: UserManager, facebookDidLogIn: User)
    
    func manager(manager: UserManager, logInDidFail error: ErrorType)
    
    func manager(manager: UserManager, facebookDidLogOut: User)
...
extension UserManager {
    ...
    func updateUserInfo(userId: String, withNewUser newUser: User) {
        ...
        firebaseDatabase.child("users").child(userId).setValue(newUserJSON)
